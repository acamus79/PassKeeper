...
public class HashUtility {
    ...
    /**
     * Verifica si la contraseña coincide con el hash almacenado en la base de
     * datos.
     *
     * @param inputPassword La contraseña proporcionada por el usuario para la
     *                      verificación.
     * @param storedHash    El hash almacenado en la base de datos que se desea
     *                      comparar.
     * @param salt          El salt del usuario
     * @return true si la contraseña coincide con el hash almacenado, false en caso
     *         contrario.
     */
    ...
    /**
     * Este método cifra la cadena de datos proporcionada utilizando el algoritmo de
     * cifrado especificado
     * y la clave proporcionada como sal. El resultado se devuelve como una cadena
     * Base64 codificada.
     *
    ...
    /**
     * Este método descifra la cadena cifrada proporcionada utilizando el algoritmo
     * de cifrado especificado
     * y la clave proporcionada como sal. El resultado se devuelve como una cadena
     * de texto sin cifrar.
     *
    ...
    /**
     * Genera una contraseña aleatoria segura con letras mayúsculas, minúsculas,
